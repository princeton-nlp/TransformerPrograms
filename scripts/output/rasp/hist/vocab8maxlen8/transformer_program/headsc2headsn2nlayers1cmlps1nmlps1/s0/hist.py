...
def run(tokens):
    ...
    classifier_weights = pd.read_csv(
        "output/rasp/hist/vocab8maxlen8/transformer_program/headsc2headsn2nlayers1cmlps1nmlps1/s0/hist_weights.csv",
        index_col=[0, 1],
        dtype={"feature": str},
    )
    # inputs #####################################################
